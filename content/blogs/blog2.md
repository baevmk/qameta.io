+++
title = "Allure 2.0-BETA5 released"
date = "2017-02-16T12:00:00+03:00"
tags = ["allure","release"]
categories = ["blog"]
author = "baev"
+++
...
![Tree icons](/img/blog/allure-2.0-beta5/tree-icons.png)
...
![TestNG nested suites](/img/blog/allure-2.0-beta5/testng-nested-suites.png)

And finally, Allure now shows method names instead of titles in packages tab.

![Packages tab](/img/blog/allure-2.0-beta5/packages-tab.png)
<img width="100%" alt="Packages" src="/img/blog/allure-2.0-beta5/packages.png">
